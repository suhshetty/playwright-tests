// File: FireSafetyManagementNavigation1.spec.js
...
// Define navigation steps for Fire Safety module - Part 1 (General Overview through Activities)
...
test('Visual Regression Test - Fire Safety Management Part 1 - Compare url1 and url2', async ({ page, context }) => {
